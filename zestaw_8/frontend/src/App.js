        ...
        <div>
          ...
          <nav>
            ...
            <ul>
              ...
              {/* POPRAWKA: Zamknięto poprawnie tag </li> na samym końcu */}
              <li><Link to="/login" style={{ float: 'right', fontWeight: 'bold' }}>Zaloguj się</Link></li>
            </ul>
          </nav>
          ...
          <Routes>
            ...
            {/* Nowe adresy dla systemu uwierzytelniania */}
